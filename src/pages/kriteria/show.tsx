...
export const KriteriaShow: React.FC = () => {
  const navigate = useNavigate();

  const breadcrumbItems = [
    { text: "Home", href: "/dashboard" },
    { text: "Kriteria", href: "/beasiswa" },
    { text: "Detail", href: "/beasiswa/show", isActive: true }
  ];

  const kriteriaItems = [
    { title: "Minimum GPA", description: "3.5" },
    { title: "Full-time student status", description: "Required" },
    { title: "Letter of recommendation", description: "Required" },
    { title: "Personal statement", description: "Required" },
    { title: "Academic transcript", description: "Required" }
  ];
